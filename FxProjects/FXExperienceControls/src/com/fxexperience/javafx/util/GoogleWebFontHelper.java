package src.com.fxexperience.javafx.util;
...
/**
 * This is a simple helper class that lets you use fonts from the Google Web
 * Fonts service inside JavaFX. You can use the fonts in code or CSS.
 * 
 * In Code all you need to do is: Font myFont =
 ...
 * Font.font(GoogleWebFontHelper.loadFont("http://....."), 40); Then you can
 * just use the name of the font in CSS like: #MyNodeID { -fx-font-family:
 * 'Seaweed Script'; -fx-font-size: 30px; }
 * 
 ...
 * 
 * 3. Add this code to your website: &lt;link
 * href='http://fonts.googleapis.com/css?family=Raleway:100' rel='stylesheet'
 * type='text/css'&gt;
 * 
...
public class GoogleWebFontHelper {
	 ...
	 * font in them.
	 * 
	 * @param googleFontCssUrl
	 *            The url to css stylesheet with @fontface definition
