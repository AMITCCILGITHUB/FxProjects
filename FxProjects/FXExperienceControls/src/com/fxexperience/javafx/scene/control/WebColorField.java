...
public class WebColorField extends InputField {
	...
	/**
	 * The value of the WebColorField. If null, the value will be treated as
	 * "#000000" black, but will still actually be null.
	 */
	private ObjectProperty<Color> value = new SimpleObjectProperty<Color>(this,
			"value");
