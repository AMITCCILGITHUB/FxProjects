...
import src.com.fxexperience.javafx.scene.control.DoubleField;
...
public class DoubleFieldSkin extends InputFieldSkin {
	...
	public DoubleFieldSkin(final DoubleField control) {
		...
		control.valueProperty().addListener(
				doubleFieldValueListener = new InvalidationListener() {
	...
	public void dispose() {
		...
		((DoubleField) control).valueProperty().removeListener(
