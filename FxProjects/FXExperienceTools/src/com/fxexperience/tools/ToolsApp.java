package src.com.fxexperience.tools;
...
import src.com.fxexperience.tools.caspianstyler.CaspianStylerMainFrame;
import src.com.fxexperience.tools.derivationcalc.DerivationCalcContent;
import src.com.fxexperience.tools.splineeditor.SplineEditor;
...
public class ToolsApp extends Application {
	...
	public void start(Stage primaryStage) throws IOException {
		...
		tools = new Tool[] {
				new Tool(
						"Caspian Styler",
						(Parent) FXMLLoader.load(CaspianStylerMainFrame.class
								.getResource("CaspianStylerMainFrame.fxml")),
						new Image(
								ToolsApp.class
